...
export type PrayerFormProps = {
  ...
  // Where the form posts: '/api/prayers' for the legacy home page,
  // '/api/orgs/[slug]/prayers' for per-church pages.
  postUrl: string
  privacyHref: string
  termsHref: string
}
...
export default function PrayerForm({
  ...
  const smsEnabled = smsNumber !== null
  ...
  return (
    <main className="min-h-screen flex items-center justify-center px-4 py-16">
      <div className="w-full max-w-md">
        ...
        {/* Texting info + required SMS disclosures. Public by design — for
            Redemption this is the consent/CTA evidence page referenced in the
            A2P 10DLC campaign registration (see message_flow). */}
        {smsEnabled && (
          <div
          ...
          >
            ...
            <p className="text-sm text-ink-500 leading-relaxed">
              ...
              <span className="text-ink-700 font-medium">{smsNumber}</span>.
